...
public class GearTest extends Utility
{
    ...
    public void  userShouldAddProductSuccessFullyToShoppinCart() throws InterruptedException
    {
       ...
       // Click on ‘shopping cart’ Link into message
        ...
        String expectedTotal1 = "$135.00";
        String actualTotal1 = getTextFromElement(By.xpath("/html[1]/body[1]/div[1]/main[1]/div[3]/div[1]/div[2]/form[1]/div[1]/table[1]/tbody[1]/tr[1]/td[4]/span[1]/span[1]/span[1]"));
